...
public class ClickHouseSQLDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface {
    ...
    public String getURL( String hostname, String port, String databaseName ) {
            return "jdbc:clickhouse://" + hostname + ":" + port +"/"+databaseName;
    }
    @Override
    ...
    public String[] getUsedLibraries() {
        return new String[] { "clickhouse-jdbc-0.1.40.jar" };
    }
    /**
